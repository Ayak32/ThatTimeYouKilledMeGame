...
#         # Fix piece owner references to point to the new player copies
#         for era in [game_copy.board.past, game_copy.board.present, game_copy.board.future]:
#             for row in era.grid:
#                 for space in row:
#                     if space.piece:
#                         # Check if owner is stored as string or player object
#                         owner_id = space.piece.owner if isinstance(space.piece.owner, str) else space.piece.owner._color
#                         if owner_id == "w_player":
#                             space.piece.owner = game_copy.w_player
#                         else:
#                             space.piece.owner = game_copy.b_player
