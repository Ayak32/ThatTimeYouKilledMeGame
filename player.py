...
#         self.era_score = 3  # Starting score
#         self.advantage_score = 0
#         self.supply_score = 4  # Starting score
#         self.centrality_score = 0
#         self.focus_score = 1  # Starting score
...
#         """Calculate all scores for the player"""
#         pieces_in_focus = 0
#         for row in self.current_era.grid:
#             for space in row:
#                 if space.piece and space.piece.owner == self:
#                     pieces_in_focus += 1
#         self.focus_score = pieces_in_focus

#         pieces_in_center = 0
#         for era in [board.past, board.present, board.future]:
#             for i in range(1, 3):  # Center rows
#                 for j in range(1, 3):  # Center columns
#                     if era.grid[i][j].piece and era.grid[i][j].piece.owner == self:
#                         pieces_in_center += 1
#         self.centrality_score = pieces_in_center

#         # Update other scores as needed
#         # For now, we'll keep era_score, advantage_score, and supply_score at their current values
